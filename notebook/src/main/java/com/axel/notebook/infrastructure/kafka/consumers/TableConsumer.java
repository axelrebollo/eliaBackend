...
import com.axel.notebook.application.services.consumers.ITableConsumer;
...
@Service
public class TableConsumer implements ITableConsumer {
    ...
    @Bean
    public KafkaAdmin.NewTopics createTableTopics() {
        return new KafkaAdmin.NewTopics(
                new NewTopic("tables", 1, (short) 1)
        );
    }
    ...
    @KafkaListener(topics = "response-idProfile-table", groupId = "table-group-consumer")
