...
import com.axel.notebook.application.services.consumers.IGroupConsumer;
...
public class GroupConsumer implements IGroupConsumer {
    ...
    @Bean
    public KafkaAdmin.NewTopics createGroupTopics() {
        return new KafkaAdmin.NewTopics(
                new NewTopic("groups", 1, (short) 1)
        );
    }
    ...
    //Listen to "response-idProfile-group", only one instance from group is processed
    @KafkaListener(topics = "response-idProfile-group", groupId = "group-group-consumer")
